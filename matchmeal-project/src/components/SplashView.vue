...
<template>
  <div class="fixed inset-0 z-[100] bg-gray-100 flex items-center justify-center font-sans">
    <!-- Mobile Frame -->
    <div class="relative w-[375px] h-[812px] bg-white shadow-2xl rounded-[35px] overflow-hidden border-[8px] border-slate-850 flex flex-col">
      ...
      <!-- Original Splash Content applied to the inner frame -->
        ...
        >
          ...
          <div class="relative mb-6">
            <div class="relative w-24 h-24 bg-white rounded-3xl shadow-float flex items-center justify-center z-10 animate-bounce-subtle">
              <Utensils :size="48" class="text-primary-600" />
            </div>
            <!-- Ripple Effect -->
          ...
          <div class="bg-white/40 backdrop-blur-md rounded-2xl p-4 border border-white/40 shadow-sm animate-fade-in-delayed">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                ...
                <p class="text-xs text-slate-700 font-bold line-clamp-1">오늘의 건강 파트너: 매치밀 프리미엄</p>
              </div>
            </div>
          </div>
