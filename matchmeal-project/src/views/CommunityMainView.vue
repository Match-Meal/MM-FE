    ...
    >
      ...
      <transition name="slide">
        <div v-if="isSearchOpen" class="px-4 py-3 bg-white border-b z-10 space-y-3">
          ...
          <div class="flex flex-col gap-2">
            ...
            <select
              v-model="searchType"
              class="bg-gray-100 text-xs rounded-lg px-2 h-9 focus:outline-none w-full appearance-none"
            >
            ...
            <div class="flex items-center gap-2">
              <input
                type="date"
                v-model="startDate"
                class="bg-gray-100 text-xs rounded-lg px-2 h-9 flex-1 focus:outline-none min-w-0"
                placeholder="시작일"
              />
        ...
        <div class="px-4 py-3 flex flex-col gap-3">
          ...
          <div class="flex justify-end border-t pt-2 border-gray-100">
            <select
              ...
              class="text-xs focus:outline-none bg-white font-bold text-gray-500 py-1"
            >
      ...
      <main class="flex-1 overflow-y-auto bg-gray-100 p-4 pb-20 no-scrollbar">
        ...
        <div v-else class="space-y-4">
          ...
          >
            ...
            <div class="flex items-center gap-3 mb-3">
              <div
                class="w-10 h-10 bg-gray-200 rounded-full overflow-hidden flex items-center justify-center text-lg border border-gray-100"
              >
                <img
                ...
                <div class="flex items-center gap-2">
                  <p
                    :class="[
                      ...
                      !post.user?.userName ? 'text-gray-400' : '',
                    ]"
                  >
            ...
            <div
              ...
              class="h-40 bg-gray-100 rounded-xl mb-3 overflow-hidden relative"
            >
              <img
                v-if="post.images[0]"
              ...
              <div
                ...
                class="absolute bottom-2 right-2 bg-black/60 text-white text-[10px] px-2 py-1 rounded-full"
              >
            ...
            <div class="flex items-center gap-4 text-gray-400 text-xs">
              ...
              <div class="flex items-center gap-1"><span>💬</span> {{ post.commentCount }}</div>
            </div>
          </div>
        </div>
        ...
        <div v-if="pageInfo && pageInfo.totalPage > 1" class="py-6 flex justify-center gap-2">
          ...
          <span class="text-xs flex items-center px-2"
