  ...
  <div class="flex-1 flex flex-col relative overflow-hidden bg-white">
    ...
    <header class="bg-white border-b border-slate-100 sticky top-0 z-10">
      <div class="relative h-14 flex items-center px-4">
        ...
        <h1
          class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-lg font-bold text-slate-800 flex items-center gap-2"
        >
          AI 챗봇
        </h1>
      </div>
    ...
    <div class="flex-1 overflow-hidden relative flex flex-col">
      ...
      >
        ...
        >
          ...
          <div
            ...
            class="flex flex-col items-center justify-center py-8 text-primary-600 animate-pulse"
          >
          ...
          <div v-else class="flex flex-col gap-2">
            ...
            <div
              ...
              v-html="renderMarkdown(feedbackResult ? getSummary(feedbackResult) : '')"
            ></div>

            <!-- Expand Button & Details -->
            <div
              v-if="feedbackResult && feedbackResult.includes('---')"
            ...
            >
              ...
              >
                ...
                <component
                  :is="isFeedbackExpanded ? 'ChevronUp' : 'ChevronDown'"
                  :size="14"
                  class="ml-1"
                />
              </button>
              ...
              <div
                ...
                v-html="renderMarkdown(getDetails(feedbackResult))"
              ></div>
            </div>
          </div>
          ...
          <div
            v-if="!mealPlanLoading"
            class="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-3"
          >
            <button
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col gap-2">
            ...
            <div
              class="text-xs text-slate-700 leading-relaxed result-markdown"
              v-html="renderMarkdown(recommendResult ? getSummary(recommendResult) : '')"
            ></div>

            <!-- Expand Button & Details -->
            <div
              v-if="recommendResult && recommendResult.includes('---')"
              class="border-t border-slate-100 pt-2 mt-2"
            >
              <button
              ...
              >
                ...
                <span v-else>상세 내용 접기</span>
                <component
                  :is="isRecommendExpanded ? 'ChevronUp' : 'ChevronDown'"
                  :size="14"
                  class="ml-1"
                />
              </button>
              ...
              <div
                ...
                class="result-markdown animate-fade-in-down pt-3 text-xs text-slate-700 leading-relaxed"
                v-html="renderMarkdown(getDetails(recommendResult))"
              ></div>
            </div>
          </div>
      ...
      <div v-if="currentTab === 'chat'" class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div
          class="bg-white border-b border-slate-100 p-2 flex justify-center gap-2 flex-shrink-0 z-10 shadow-sm"
        >
          <button
                  ...
                  >
                    ...
                    <div v-else class="flex flex-col gap-2">
                      ...
                      <div
                        ...
                        v-html="renderMarkdown(item.summary || item.text)"
                      ></div>
                      ...
                      <div v-if="item.details" class="border-t border-slate-100 pt-2 mt-1">
                        ...
                        >
                          ...
                          <component
                            :is="expandedMessages.has(item.id) ? 'ChevronUp' : 'ChevronDown'"
                            :size="14"
                            class="ml-1"
                          />
                        </button>
                      ...
                      <!-- Details (Collapsible) -->
                      <div
                        v-if="item.details && expandedMessages.has(item.id)"
                        class="result-markdown animate-fade-in-down pt-1"
                        v-html="renderMarkdown(item.details)"
                      ></div>
                    </div>
                  </div>
        ...
        >
          ...
          <div class="flex flex-col gap-2">
            <div
              ...
              v-html="renderMarkdown(item.answer ? getSummary(item.answer) : '')"
            ></div>
            <div
              v-if="item.answer && item.answer.includes('---')"
              class="border-t border-slate-100 pt-2 mt-1"
            >
              <button
              ...
              >
                ...
                <span v-else>상세내용 접기</span>
                <component
                  :is="expandedMessages.has(`history-${index}`) ? 'ChevronUp' : 'ChevronDown'"
                  :size="14"
                  class="ml-1"
                />
              </button>
              <div
                v-if="expandedMessages.has(`history-${index}`)"
                class="result-markdown animate-fade-in-down pt-1 text-xs text-slate-800 leading-relaxed"
                v-html="renderMarkdown(getDetails(item.answer))"
              ></div>
            </div>
          </div>
        </div>
...
const pendingContext = ref<{
  question: string
  answer: string
  type: 'FEEDBACK' | 'RECOMMENDATION' | 'CHAT'
} | null>(null)
